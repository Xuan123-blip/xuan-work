...
def receiveOnePing(mySocket, ID, sequence, destAddr, timeout):
    ...
    while 1:
        ...
        if type == 0 and packetID == ID:  # type should be 0
            ...
            return (delay, byte_in_double)

    # 3. Compare the time of receipt to time of sending, producing the total netwo
...
def ping(host, timeout=1):
    ...
    for i in range(4):
        ...
        if result == -1:
            ...
            total = total + delay
            print("Received from " + dest + " delay=" + str(delay) + "ms ")
